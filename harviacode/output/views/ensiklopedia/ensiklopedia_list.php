            ...
            <div class="card-body">
              <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                      <?php echo anchor(site_url($module.'/ensiklopedia/create'), '+ Tambah Data', 'class="btn btn-primary"'); ?>
      	    </div>
              </div>
                ...
                <div class="table-responsive m-t-40">
                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          <?php foreach ($dataensiklopedia as $d): ?>
                            <tr>
                              <?php foreach ($datafield as $df): ?>
                                <td><?php echo $d->$df ?></td>
                              <?php endforeach; ?>
                                <td>
                                <a href="<?php echo base_url().$module?>/ensiklopedia/edit/<?php echo $d->ID ?>">
